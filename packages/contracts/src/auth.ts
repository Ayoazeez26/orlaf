...
export interface PasswordResetVerifyOtpBody {
  reset_id: string;
  code: string;
}
...
export interface PasswordResetResendBody {
  reset_id: string;
}
...
export interface PasswordResetVerifyMfaBody {
  mfa_token: string;
  code: string;
}
